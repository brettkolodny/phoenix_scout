defmodule PhoenixScoutWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PhoenixScoutWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PhoenixScoutWeb.Gettext, "errors", msg, opts)
    # end
